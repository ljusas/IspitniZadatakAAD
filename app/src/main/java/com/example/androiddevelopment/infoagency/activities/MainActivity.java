...
public class MainActivity extends AppCompatActivity
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_add_news) {
            ...
            final EditText editDate = dialog.findViewById(R.id.choosen_news_date);
            image = dialog.findViewById(R.id.choosen_news_image);
            final Button addDate = dialog.findViewById(R.id.click_news_date);
            final Button addImage = dialog.findViewById(R.id.click_news_image);
